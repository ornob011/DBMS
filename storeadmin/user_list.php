...
if (isset($_GET['yesdelete'])) {
    ...
    $sql = mysqli_query($conn, "DELETE FROM customer WHERE id='$id_to_delete' LIMIT 1") or die(mysqli_error($conn));
...
if (isset($_POST['name'])) {
    ...
    $sql = mysqli_query($conn, "INSERT INTO customer (login, password, name, mobile, security, securityanswer, email, address, city, state, pin) 
        VALUES('$login', '$password','$name','$mobile','$security','$securityanswer','$email','$address','$city','$state','$pin')") or die(mysqli_error($conn));
...
<?php
$customer_list = "";
$sql = mysqli_query($conn, "SELECT * FROM customer ORDER BY id DESC");
    ...
    <div align="center" id="mainWrapper">
        ...
        <div id="pageContent"><br />
            <div align="right" style="margin-right:32px"> <a href="http://localhost/dbms/storeadmin/logout.php">Logout</a> &middot;
                <a href="user_list.php#userForm">+ Add New Customer</a>
            </div>
